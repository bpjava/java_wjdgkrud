...
public class CalendarEx9 {
	...
	public static void main(String[] args) {
		...
		System.out.println("2012.6.01 : "+getDayOfWeek(2012,6,1));
		System.out.println("2014.5.01 : "+dayDiff(2014,5,1,2014,4,28));
	...
	public static String convertDayToDate(int day) {
		...
		while(true) {
			int aYear = isLeepYear(year)?366:365;
			if(day>aYear) {
				day-=aYear;
				year++;
			}else {
		...
		while(true) {
			...
			if(isLeepYear(year)&&month==1) endDay++;
